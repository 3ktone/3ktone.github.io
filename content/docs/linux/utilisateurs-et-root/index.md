---
title: "Gestion des utilisateurs, sudo et compte root"
description: "Comprendre les utilisateurs Linux, les privilèges sudo et les éditeurs de texte du terminal."
summary: "Comprendre les utilisateurs Linux, les privilèges sudo et les éditeurs de texte du terminal."
date: "2024-11-19T10:31:44+01:00"
lastmod: "2024-11-19T10:31:44+01:00"
draft: false
weight: 50
categories: ["Linux"]
tags: ["utilisateurs", "permissions", "root", "sudo", "Nano", "Vim"]
aliases: ["/posts/i-am-root/"]
...
- Ouvrir une session d’administration root :
  ```bash
  sudo -i
  ```  
...
- **sudo** : "Super User Do" permet d'executer une commande avec des privileges administratifs. Exemple :  
  ...
  sudo apt update
  ```  
- **sudo -i** : Passer au super utilisateur.
